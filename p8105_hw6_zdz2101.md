...
![](p8105_hw6_zdz2101_files/figure-markdown_github/unnamed-chunk-4-6.png) I chose to use an "automatic" process, using step-wise regression with backward elimation. We just learned how to do this in Biostats Methods 1 over the past week or so. The end product was a model using 11 variables for prediction: babysex, bhead, blength, delwt, fincome, gaweeks,mheight, mrace, parity, ppwt, and smoken.
